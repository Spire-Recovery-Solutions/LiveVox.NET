...
{
    public class ResumeSupervisorCallRequest : ILiveVoxRequest
    {
        [JsonIgnore]
        public string? Category { get; set; } = "callControl";

        [JsonIgnore] 
        public string? Resource { get; set; } = "agent/conference/supervisor/resume";
        ...
        public ResumeSupervisorCallRequest(LineNumber lineNumber)
        {
