...
namespace LiveVox.NET.Models.Call.Requests.Agent.CallRecordingControls
{
    public class PauseCallRecordingRequest : ILiveVoxRequest
    {
        ...
        [JsonIgnore] public string? Resource { get; set; } = "agent/callRecord/pause";
        ...
        public PauseCallRecordingRequest(LineNumber lineNumber)
        {
            LineNumber = lineNumber;
        }

        /// <summary>
        /// The line of the call which the Agent is pausing the call recording
        /// </summary>
