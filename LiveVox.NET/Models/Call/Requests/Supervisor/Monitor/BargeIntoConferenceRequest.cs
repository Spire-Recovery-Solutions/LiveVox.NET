...
{
    public class BargeIntoConferenceRequest: ILiveVoxRequest
    {
        [JsonIgnore]
        public string? Category { get; set; } = "callControl";

        [JsonIgnore] 
        public string? Resource { get; set; } = "supervisor/monitor/barge";
        ...
        public BargeIntoConferenceRequest(string agentLoginId)
        {
            AgentLoginId = agentLoginId;
        }

        /// <summary>
        /// ID of the Agent conference to barge into.
        /// </summary>
