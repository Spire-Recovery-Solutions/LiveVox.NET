...
{
    public class GetRouteStatusRequest : ILiveVoxRequest
    {
        [JsonIgnore]
        public string? Category { get; set; } = "callControl";

        [JsonIgnore] 
        public string? Resource { get; set; } = "routing/voice/route/status";
        ...
        public GetRouteStatusRequest(string correlationId, string dialedNumber, string customerNumber)
        {
